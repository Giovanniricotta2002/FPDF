...
class FPDF
{
    ...
    *******************************************************************************/
     ...
     * @param string $unit User unit ('pt', 'mm', 'cm' or 'in')
     * @param string|array $size Page size ('A4', 'Letter', ... or [width, height])
     */
     ...
     * @param float|null $right Right margin (defaults to $left)
     * @return void
     */
    ...
    /**
     * @param string|int $zoom 'fullpage', 'fullwidth', 'real', 'default' or a zoom factor
     * @param string $layout 'single', 'continuous', 'two' or 'default'
     * @return void
     */
    ...
    /**
     * @param int $r Red (or gray level if $g and $b omitted)
     * @param int|null $g Green
     * @param int|null $b Blue
     * @return void
     */
     ...
     * @param float $w
     * @param float $h
     * @param string $style 'D' (draw), 'F' (fill) or 'DF'/'FD' (both)
     * @return void
     */
     ...
     * @param string $family
     * @param string $style
     * @param float $size Size in points
     * @return void
     */
    ...
    /**
     * @param int $link Link identifier
     * @param float $y
     * @param int $page
     * @return void
     */
     ...
     * @param float $w
     * @param float $h
     * @param int|string $link Internal link identifier or URL
     * @return void
     */
     ...
     * @param float $h
     * @param string $txt
     * @param int|string $border 0, 1 or a subset of 'LTRB'
     * @param int $ln 0, 1 or 2
    ...
    /**
     * @param float|null $h Defaults to the last cell height
     * @return void
     */
    ...
    /**
     * @param string $dest 'I', 'D', 'F' or 'S'
     * @param string $name
     * @param bool $isUTF8
     * @return string Empty string, except for destination 'S'
     */
    ...
    *******************************************************************************/
    ...
    protected function _loadjsonfont(string $path): array
    {
    ...
    protected function _loadphpfont(string $path): array
    {
